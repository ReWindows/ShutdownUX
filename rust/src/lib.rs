//! Windissect-generated Rust FFI bindings for ShutdownUX.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "1C80E48FAFEB65ACF2834872F08F30E2";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 3417419722;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 15] = [83, 104, 117, 116, 100, 111, 119, 110, 85, 88, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 3417419722 { return 0; }
