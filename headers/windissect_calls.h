...
static constexpr wchar_t module_name[15] = {0x0053, 0x0068, 0x0075, 0x0074, 0x0064, 0x006F, 0x0077, 0x006E, 0x0055, 0x0058, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 3417419722U || rva >= image_size) return nullptr;
return base + rva;
}
